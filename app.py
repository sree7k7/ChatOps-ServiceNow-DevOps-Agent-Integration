...
from chat_ops_service_now_dev_ops_agent_integration.ServiceNowDevOpsMiddleware import ServiceNowMiddlewareStack
...
app = cdk.App()
ServiceNowMiddlewareStack(app, "ServiceNowMiddlewareStack",
